import type { IdeologyVector, PartyDefinition } from "@/game/types";
...
export function buildCustomParty(input: CustomPartyInput): PartyDefinition {
  ...
  return {
    ...
    uniqueEventTags: ["custom_party", input.leadershipModel, input.organizationPriority],
