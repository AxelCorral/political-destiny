...
| `consent_updated`     | Quand le joueur clique « Activer les statistiques anonymes » ou « Désactiver les statistiques anonymes » dans Paramètres.                                                                                                                                                                                                  | `state` = `granted` ou `denied`. Un refus n'a rien à envoyer par construction (la file est vidée avant tout envoi possible) — seul un octroi peut réellement partir.                                                               |
