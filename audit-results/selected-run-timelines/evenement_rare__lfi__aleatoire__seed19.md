# lfi · aleatoire · seed 19

Parti : **lfi** (existing) — Agent : **aleatoire** — Graine : `post-audit-19` — Méthode : union
Résultat : éliminé au 1er tour — score final 48/100 — fin `kingmaker`
Score 1er tour : 12.2 — Score 2nd tour : n/a — Progression : -0.8
Répétitions dans cette partie : 0 titres, 0 récits (dont 0 justifiées par une chaîne)
Mémoire/monde : 4 souvenirs d'acteurs, 65 actions adverses (alliance|crisis|endorsement|strategy), 0 alliance(s), 0 remplacement(s)
Idéologie : mouvement total 10.77 points, axe le plus mobile 6.29 points
...
**2. La désobéissance européenne doit être définie** _(party)_
...
**4. Les parrainages restent sous le seuil** _(campaign)_
...
**5. Une minute sur les loyers** _(media)_
...
**6. Le car tombe en panne** _(campaign)_
...
**7. Une motion réclame un congrès** _(internal)_
...
**8. Un fichier militant sort du siège** _(scandal)_
...
**10. Nassim Courbet réclame une ligne plus sociale** _(party)_
...
**11. La porte-parole annonce trop tôt** _(internal)_
...
**12. Le PS propose trois engagements communs** _(alliance)_
...
**13. Ce que l’école doit transmettre** _(program)_
...
**16. Deux équipes se disputent le terrain** _(internal)_
...
**19. Le slogan divise le siège** _(campaign)_
...
**22. Votre voix ne tient plus** _(rare)_
...
**24. Le débat sur les pouvoirs exceptionnels** _(rare)_
- Choix : Refuser tout engagement préalable et défendre la liberté d’appréciation du chef de l’État [PRÉSIDENTIEL]
- Conséquence : *La décision resterait présidentielle* — Vous rappelez que les crises ne peuvent être écrites à l’avance et conservez une marge maximale. L’absence de garde-fous supplémentaires augmente cependant la méfiance envers votre conception du pouvoir.
...
- Conséquence : *La défaite devient matière à apprendre* — Le mandat de la revue inclut les événements décisifs, les dépenses et les contradictions. Vous retardez les accords électoraux mais construisez un héritage utile au prochain cycle.
