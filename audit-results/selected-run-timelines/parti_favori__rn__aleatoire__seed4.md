...
Score 1er tour : 17.4 — Score 2nd tour : 45 — Progression : 4.9
...
Idéologie : mouvement total 21.73 points, axe le plus mobile 6.93 points
...
**2. Les règles de la liste commune** _(internal)_
- Choix : Faire élire les responsables par les adhérents avec une représentation minimale de chaque courant [RASSEMBLEUR]
- Conséquence : *Les courants obtiennent une règle commune* — Le vote prend une semaine et produit une direction diverse dont la légitimité est difficile à contester. Les arbitrages quotidiens seront plus lents, mais les perdants acceptent publiquement le résultat.

**3. Un donateur demande un rendez-vous** _(internal)_
- Choix : Refuser le tête-à-tête et proposer une contribution écrite publiée avec votre réponse [PRUDENT]
- Conséquence : *Léchange laisse une trace publique* — Le donateur transmet ses propositions et votre réponse écarte celles qui contredisent le programme. La procédure est sobre, vérifiable et identique à celle offerte aux autres organisations.
...
- Conséquence : *La mesure devient une condition de résidence* — Le dispositif paraît plus robuste juridiquement et conserve une priorité liée à la contribution. Le courant identitaire dénonce l’abandon d’un symbole central de la campagne.
...
- Conséquence : *La campagne garde son nom* — Les affiches restent sobres et aucun slogan ne détourne le programme. Les équipes locales manquent toutefois d’une formule commune pour lancer leurs réunions.
...
- Conséquence : *Les attaques cessent sans fusion programmatique* — La campagne peut travailler sa crédibilité économique sans répondre chaque jour à Reconquête. Le partenaire continue cependant à contester la ligne et ne garantit aucun retrait au premier tour.
...
**11. La règle européenne à changer** _(program)_
- Choix : Proposer un budget européen permanent financé par des ressources communes [CLIVANT]
- Conséquence : *Le fédéralisme budgétaire est assumé* — La proposition donne une direction de long terme à votre projet et attire les plus européistes. Elle crée également une ligne d’attaque simple pour les souverainistes et complique les alliances du second tour.
- Déclaration : initial_position
...
- Conséquence : *L’obligation structure le débat* — La mesure est immédiatement comprise dans les communes touchées, tandis que les représentants des jeunes médecins dénoncent une contrainte injuste. Vous gagnez un marqueur puissant et un conflit durable à arbitrer.
...
**17. Une minute sur les loyers** _(media)_
- Choix : Annoncer la garantie publique des loyers étudiants et renvoyer le financement au programme [POPULAIRE]
- Conséquence : *La garantie tient dans le format* — La proposition est immédiatement comprise et reprise dans les associations étudiantes. Les questions de coût arrivent ensuite, mais vous avez enfin une mesure identifiable sur le logement des jeunes.
- Déclaration : initial_position
...
- Conséquence : *La somme disparaît des comptes, pas des courriels* — La correction juridique est complète et l’équipe locale poursuit son travail. Un courriel interne sur l’avertissement peut toutefois donner l’impression que la campagne a tenté de cacher une faute mineure.
...
**20. Le RN arbitre normalisation et mobilisation** _(party)_
...
**24. La promesse faite à l’école** _(program)_
...
- Conséquence : *Cinq décisions dessinent un gouvernement* — Vous répondez aux relances sans ajouter de promesse et rendez votre première année prévisible. La maîtrise des arbitrages convainc des électeurs qui hésitaient encore sur votre capacité à gouverner.
...
- Conséquence : *Le favori parle déjà à tout le pays* — Ladresse réduit votre rejet et rassure les électeurs modérés sur la stabilité du lendemain. Les militants les plus actifs regrettent un ton qui considère presque la victoire acquise.
...
- Conséquence : *La dernière semaine vise les abstentionnistes* — Le message remobilise le socle et peut attirer des électeurs éloignés du vote. Les soutiens de droite se retirent et le rejet augmente parmi les indécis modérés.
