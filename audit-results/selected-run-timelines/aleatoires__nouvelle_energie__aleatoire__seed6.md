...
Résultat : éliminé au 1er tour — score final 61/100 — fin `kingmaker`
Score 1er tour : 11.5 — Score 2nd tour : n/a — Progression : 7
Répétitions dans cette partie : 0 titres, 0 récits (dont 0 justifiées par une chaîne)
Mémoire/monde : 1 souvenirs d'acteurs, 57 actions adverses (alliance|crisis|endorsement|replacement|strategy), 0 alliance(s), 1 remplacement(s)
...
- Conséquence : *Un simulateur rend la réforme visible* — Les utilisateurs comprennent enfin qui gagne et qui perd, puis partagent largement leurs résultats. Les cas défavorables deviennent aussi des captures faciles pour les adversaires.
- Déclaration : initial_position
...
- Conséquence : *Le réseau économique devient un forum public* — La transparence attire salariés, artisans et élus autour des mêmes problèmes pratiques. L’organisation demande plus de temps et certaines entreprises préfèrent se retirer plutôt que publier leur soutien.
...
- Conséquence : *Le parti quitte le second tour* — Votre autonomie ne peut être confondue avec un soutien et votre socle le plus méfiant lapprécie. Vous abandonnez toute influence sur les deux semaines où le pays choisit son président.
