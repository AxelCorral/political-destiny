...
Parti : **lr** (existing) — Agent : **aleatoire** — Graine : `post-audit-7` — Méthode : rupture
Résultat : éliminé au 1er tour — score final 40/100 — fin `divided_party`
Score 1er tour : 7.5 — Score 2nd tour : n/a — Progression : 1
...
Idéologie : mouvement total 14.41 points, axe le plus mobile 7.49 points
...
**2. Un soutien éditorial encombrant** _(media)_
...
**4. La promesse faite après la primaire** _(internal)_
...
**6. Horizons propose un accord économique** _(party)_
- Choix : Signer la plateforme et inscrire la frontière avec le RN dans le préambule [RASSEMBLEUR]
- Conséquence : *Une plateforme réunit la droite modérée* — Les équipes économiques mutualisent leurs experts et plusieurs élus Horizons rejoignent les déplacements. L’aile droite de LR refuse le préambule et menace de ne plus distribuer le matériel.
...
**8. Le slogan divise le siège** _(campaign)_
...
**10. La sécurité du quotidien exige des moyens** _(party)_
- Choix : Signer des contrats locaux liant renforts policiers, horaires judiciaires et objectifs publiés [TECHNIQUE]
- Conséquence : *Police et justice partagent des objectifs locaux* — Le dispositif évite de promettre des effectifs sans capacité judiciaire et donne aux maires des indicateurs publics. Sa coordination exige du temps et des recrutements dans plusieurs administrations.
- Déclaration : initial_position
...
**12. Le contrat d’intégration, jusqu’où aller** _(program)_
...
**14. Les retraités interrogent le financement** _(party)_
- Choix : Garantir l’exonération de l’épargne longue et flécher son avantage vers les établissements spécialisés [TECHNIQUE]
- Conséquence : *L’épargne finance une partie de l’offre* — Les épargnants disposent d’une garantie claire et les établissements obtiennent de nouveaux capitaux. Les ménages sans patrimoine voient peu d’amélioration dans leur reste à charge.

**15. Diane Mérande veut négocier à droite** _(party)_
...
**16. La une vous prête un tournant** _(media)_
...
- Conséquence : *La réponse européenne plutôt que nationale* — La cohérence avec votre ligne européenne est nette et rassure vos partenaires du continent. Une partie de votre électorat juge la réponse trop lente face à un incident qui appelait, selon elle, un signal immédiat.
- Déclaration : abrupt_reversal

**18. Les fédérations exigent un vote de ligne** _(party)_
...
**19. La promesse faite à l’école** _(program)_
...
**20. Trois minutes sur la sécurité** _(debate)_
- Choix : Financer des médiateurs, léclairage et les transports nocturnes avant de promettre de nouveaux effectifs [PRUDENT]
- Conséquence : *La prévention répond au lieu, pas à toute la peur* — Les mesures peuvent être déployées rapidement autour de la gare et convainquent les élus urbains. Une partie du public y voit une réponse périphérique qui refuse de parler de police et de sanctions.
- Déclaration : abrupt_reversal

**21. Deux invitations au même horaire** _(campaign)_
- Choix : Avancer le déplacement, rejoindre le studio en train et supprimer les répétitions [RISQUÉ]
- Conséquence : *Les deux rendez-vous survivent* — Vous tenez les deux engagements avec peu de préparation et une fatigue visible. L’image d’endurance plaît, tandis que plusieurs réponses télévisées manquent de précision.
...
- Conséquence : *Un refus devient consigne de barrage* — La hiérarchie de vos désaccords est claire et mobilise ceux qui partagent votre alerte. Le finaliste indirectement soutenu ne peut pas présenter votre geste comme une adhésion programmatique.
