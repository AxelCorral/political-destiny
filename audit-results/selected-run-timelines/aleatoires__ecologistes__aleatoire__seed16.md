# ecologistes · aleatoire · seed 16

Parti : **ecologistes** (existing) — Agent : **aleatoire** — Graine : `post-audit-16` — Méthode : presidential
Résultat : qualifié, **vainqueur** — score final 86/100 — fin `president`
Score 1er tour : 15.1 — Score 2nd tour : 62.5 — Progression : 8.6
Répétitions dans cette partie : 0 titres, 0 récits (dont 0 justifiées par une chaîne)
Mémoire/monde : 3 souvenirs d'acteurs, 69 actions adverses (crisis|endorsement|strategy), 2 alliance(s), 0 remplacement(s)
Idéologie : mouvement total 19.9 points, axe le plus mobile 8.75 points
...
- Conséquence : *Le siège traverse le périphérique* — Le changement provoque trois jours de désordre puis réduit durablement les dépenses fixes. La nouvelle adresse soutient votre récit de proximité et finance des étapes que la campagne aurait annulées.
...
- Conséquence : *Le calendrier crédibilise la méthode* — Les cent jours donnent de la matière aux entretiens et rassurent sur votre préparation. Une partie des militants regrette une campagne trop administrative.

**5. Les Écologistes arbitrent leur méthode** _(party)_
- Choix : Confier le programme aux fédérations et réserver les arbitrages de calendrier à Éloi Vernet [INSTITUTIONNEL]
- Conséquence : *Deux mandats organisent les désaccords* — La règle respecte la délibération tout en laissant la candidate déplacer une séquence urgente. Les sujets mêlant programme et tactique provoqueront encore des négociations difficiles.
...
**7. Les locataires redoutent les interdictions** _(party)_
- Choix : Interdire les congés liés aux travaux et plafonner les loyers cinq ans après une aide publique [POPULAIRE]
- Conséquence : *La rénovation s’accompagne de garanties locatives* — Les locataires comprennent qu’ils ne financeront pas seuls la transition et les associations soutiennent le dispositif. Les propriétaires bailleurs annoncent un retrait partiel du marché.
- Déclaration : initial_position

**8. Des élus ruraux proposent une tournée** _(party)_
- Choix : Passer cinq jours en Auvergne avec des ateliers sur les trajets quotidiens et les services [POPULAIRE]
- Conséquence : *La campagne écoute avant d’annoncer* — Les échanges font émerger des solutions adaptées aux distances et corrigent plusieurs propositions nationales. La tournée mobilise peu de caméras mais améliore nettement l’accueil local.
...
**13. Le gaz double en une semaine** _(world)_
...
**14. La taxe carbone divise les alliés** _(party)_
- Choix : Abandonner la hausse sur les ménages et concentrer le prix carbone sur les grands sites industriels [PRUDENT]
- Conséquence : *Le signal carbone se concentre sur l’industrie* — Les partenaires sociaux acceptent plus facilement le texte et le risque de colère immédiate recule. Les recettes diminuent et les industriels exposés réclament des protections supplémentaires.

**15. Douze députés offrent leur expérience** _(alliance)_
- Choix : Exiger un soutien sans réserve jusqu’au premier tour en échange d’un rôle programmatique [LOYAL]
- Conséquence : *Sept députés acceptent la discipline* — Le groupe se réduit mais parle d’une seule voix et travaille efficacement sur vos réformes. Les cinq refusants expliquent leur départ, donnant une visibilité indésirable aux conditions posées.

**16. Une ligne du CV est fausse** _(scandal)_
...
**18. Vingt-quatre heures sans caméra** _(media)_
...
**20. Le PS offre des circonscriptions urbaines** _(party)_
- Choix : Investir des candidatures autonomes et proposer seulement des désistements après le premier tour [CLIVANT]
- Conséquence : *L’autonomie devient la règle dans les métropoles* — Les militants disposent d’une campagne clairement écologiste et les listes locales recrutent leurs propres bénévoles. Le PS réplique en contestant l’utilité de la candidature nationale.

**21. Le studio plonge dans le noir** _(rare)_
...
**22. Le dernier grand meeting** _(campaign)_
- Choix : Récapituler cinq engagements déjà chiffrés et annoncer leur ordre d’exécution [PRÉSIDENTIEL]
- Conséquence : *Le contrat ordonne la campagne* — Les cinq engagements rappellent vos décisions les plus cohérentes et donnent une chronologie. Le meeting rassure les indécis sans provoquer de pic spectaculaire.

**23. Les factures sans pièce ressortent** _(scandal)_
...
- Choix : Proposer à toute la gauche un gouvernement de coalition lié par dix objectifs climatiques et sociaux [RASSEMBLEUR]
- Conséquence : *Dix objectifs organisent la coalition* — Les partenaires disposent de garanties précises et les militants de gauche rejoignent la campagne. Le nombre d’engagements négociés alimente les doutes sur la vitesse de décision.
