# lfi · aleatoire · seed 22

Parti : **lfi** (existing) — Agent : **aleatoire** — Graine : `post-audit-22` — Méthode : rupture
Résultat : qualifié, **vainqueur** — score final 77/100 — fin `president`
Score 1er tour : 14.5 — Score 2nd tour : 56.3 — Progression : 1.5
Répétitions dans cette partie : 0 titres, 0 récits (dont 0 justifiées par une chaîne)
Mémoire/monde : 0 souvenirs d'acteurs, 77 actions adverses (alliance|crisis|endorsement|strategy), 2 alliance(s), 0 remplacement(s)
Idéologie : mouvement total 12.57 points, axe le plus mobile 4.62 points
...
- Choix : Consacrer le direct à une convention citoyenne constitutionnelle [CLIVANT]
- Conséquence : *La proposition déplace le lancement* — La réforme institutionnelle remplace les images attendues de meeting. Les militants les plus réformateurs s’enthousiasment, tandis que les cadres découvrent le projet en direct.
...
**5. La Sixième République doit prendre forme** _(party)_
...
**6. La une vous prête un tournant** _(media)_
...
**7. Qui financera les priorités** _(program)_
...
**8. Un virement suit un trajet complexe** _(scandal)_
...
**10. Une contradiction chez le camp centriste** _(debate)_
...
**11. Les jeunes veulent leur propre campagne** _(internal)_
...
**12. La désobéissance européenne doit être définie** _(party)_
...
**13. Le meeting quitte la capitale** _(campaign)_
...
**14. Saint-Denis ouvre ses réseaux associatifs** _(party)_
...
**15. La plateforme publique tombe en panne** _(world)_
...
**17. Le marché sous pression** _(campaign)_
...
**18. Le studio plonge dans le noir** _(rare)_
...
**19. Un rival corrige votre ligne** _(internal)_
...
**21. Une proposition de pacte de non-agression** _(campaign)_
...
**22. Tensions internes chez Reconquête** _(world)_
...
**23. L’atelier industriel de Saint-Nazaire** _(campaign)_
