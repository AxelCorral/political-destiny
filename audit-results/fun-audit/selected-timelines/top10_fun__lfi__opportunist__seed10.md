...
> **Choix retenu :** Chercher dabord une coalition européenne et conditionner la désobéissance à léchec de cette démarche [RASSEMBLEUR]

**La coalition précède le rapport de force** — La méthode élargit vos reports et donne aux partenaires une chance de modifier les règles. Une partie de LFI y voit une condition susceptible de neutraliser la promesse de rupture.
...
> **Choix retenu :** Maintenir le contrat signé et défendre une rémunération liée à la performance électorale [LOYAL]
...
> **Choix retenu :** Refuser le pacte et lancer votre propre tournée populaire sur lécologie du quotidien [LOYAL]
...
Sondage : 11.9 → 13.4 (rang 3 → 1)

## 17. La fronde sociale exige un vote _(CHAÎNE)_ — _official_campaign/party_
...
> **Choix retenu :** Conditionner toute aide à un repreneur privé présentant un carnet de commandes vérifiable [TECHNIQUE]

**Laide attend un projet industriel viable** — Le critère évite de financer une activité sans débouché et attire deux candidats prudents. Les salariés vous reprochent de laisser le temps du marché décider pendant que le site perd ses compétences.
