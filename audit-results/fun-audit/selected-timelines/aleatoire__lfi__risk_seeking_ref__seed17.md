# lfi — risk_seeking_ref — graine 17

Catégorie de sélection : **aleatoire**

Score final : 81/100 · 1er tour : 16 · 2nd tour : 54.8 · qualifié : true · vainqueur : true · signaux mémorables : 3

## 1. La désobéissance européenne doit être définie — _pre_campaign/party_
...
## 3. Une minute sur les loyers — _pre_campaign/media_
...
## 4. Un virement suit un trajet complexe — _pre_campaign/scandal_
...
Sondage : 11.9 → 12.3 (rang 3 → 3)

## 7. Le prochain budget de la santé — _pre_campaign/program_
...
Sondage : 12.3 → 12.8 (rang 3 → 2)

## 8. La photographie du quai vide — _pre_campaign/media_
...
## 11. Le Conseil européen se divise — _campaign/world_
...
## 12. Qui financera les priorités — _campaign/program_
...
## 14. Le direct des questions citoyennes — _campaign/media_
...
## 15. LFI choisit entre mouvement et candidat — _campaign/party_
...
## 16. Un rival corrige votre ligne — _official_campaign/internal_
...
Sondage : 10.2 → 14.7 (rang 6 → 1)

## 18. L’atelier industriel de Saint-Nazaire — _official_campaign/campaign_
...
## 20. Les sections refusent le kit national — _official_campaign/internal_
...
Sondage : 10.9 → 15.2 (rang 5 → 1)

## 22. Cinq cents bénévoles sans mission — _official_campaign/internal_
...
## 23. Un cadre écologiste tenté par un ralliement — _official_campaign/alliance_
...
> **Choix retenu :** Négocier en privé, sans aucune annonce avant un accord ferme [SECRET]
...
## 24. Le déplacement en Guadeloupe engage — _between_rounds/campaign_
