...
> **Choix retenu :** Proposer seulement un pacte de désistement réciproque pour le second tour [PRUDENT]

**Les deux candidatures restent en lice** — Le pacte limite la violence des attaques et prépare des reports de voix. La concurrence continue néanmoins à diviser le même électorat pendant toute la campagne officielle.
...
> **Choix retenu :** Lancer le fonds avec les pays volontaires sans attendre un nouvel accord unanime [OFFENSIF]

**Un groupe pionnier contourne le blocage** — La stratégie donne un chemin rapide aux pays favorables et incarne une Europe à plusieurs vitesses. Elle risque de fragmenter le marché commun et inquiète les électeurs attachés à des règles uniformes.
...
> **Choix retenu :** Financer un chèque ciblé sur les ménages modestes et les petites entreprises exposées [PRUDENT]

**Laide protège sans geler tous les prix** — Le ciblage maintient le signal de sobriété et concentre les fonds sur les factures les plus difficiles. Les classes moyennes juste au-dessus du seuil dénoncent une protection dont elles sont exclues.
...
> **Choix retenu :** Suspendre les prochaines étapes et convoquer une conférence de financement avec les partenaires sociaux [PRUDENT]

**La réforme retourne à la négociation** — Les syndicats reprennent les échanges et le rejet recule parmi les salariés. Les soutiens réformateurs dénoncent un renoncement qui fragilise la crédibilité économique de la candidate.
...
> **Choix retenu :** Programmer six réacteurs et accélérer simultanément le solaire, l’éolien et les réseaux [TECHNIQUE]

**Deux filières, une facture massive** — La stratégie réduit le risque de dépendre d’une technologie et rassure l’industrie. Son coût d’investissement cumulé devient aussitôt l’un des principaux postes à financer de votre programme.
