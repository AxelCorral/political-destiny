# lfi — risk_seeking_ref — graine 19

Catégorie de sélection : **aleatoire**

Score final : 80/100 · 1er tour : 16 · 2nd tour : 59.4 · qualifié : true · vainqueur : true · signaux mémorables : 4
...
## 4. La directrice a recruté son frère — _pre_campaign/scandal_
...
Sondage : 12.4 → 10.8 (rang 3 → 6)

## 5. La périphérie demande un calendrier — _pre_campaign/campaign_
...
Sondage : 13.2 → 12.1 (rang 1 → 3)

## 9. Les Écologistes proposent un pacte urbain — _campaign/party_
...
Sondage : 14.1 → 16.4 (rang 1 → 1)

## 17. Une motion réclame un congrès — _official_campaign/internal_
...
## 22. La dissidence prend forme chez Reconquête — _official_campaign/world_
...
Sondage : 14.5 → 14 (rang 1 → 1)

## 23. La Sixième République doit prendre forme — _official_campaign/party_
