...
Score final : 74/100 · 1er tour : 14.5 · 2nd tour : 51.2 · qualifié : true · vainqueur : true · signaux mémorables : 4
...
Sondage : 15.4 → 13.4 (rang 1 → 1)

## 2. Une chanteuse veut soutenir la campagne  — _pre_campaign/alliance_
...
## 4. Une aciérie annonce sa fermeture  — _pre_campaign/world_
...
> **Choix retenu :** Négocier avec la région un contrat de reprise ou de formation garanti pour chaque salarié [INSTITUTIONNEL]
...
Sondage : 13.7 → 15 (rang 1 → 1)

## 5. Les abstentionnistes demandent une preuve locale  — _pre_campaign/party_
...
> **Choix retenu :** Verser une ristourne énergétique automatique aux ménages des communes peu denses [TECHNIQUE]
...
## 7. Un soutien éditorial encombrant  — _pre_campaign/media_
...
Sondage : 13.3 → 15 (rang 1 → 1)

## 10. Le déplacement en Guadeloupe engage  — _campaign/campaign_
...
> **Choix retenu :** Convoquer une conférence territoriale et laisser les élus fixer la première priorité [RASSEMBLEUR]
...
## 11. La baisse de TVA doit être ciblée  — _campaign/party_
...
> **Choix retenu :** Remplacer la baisse par un chèque trimestriel modulé selon le revenu et le territoire [TECHNIQUE]

**Un versement remplace la baisse de taxe** — Le dispositif cible davantage les ménages modestes et les zones rurales sans dépendre des marges commerciales. Le changement de promesse expose la campagne au procès en revirement.

Sondage : 15 → 15.1 (rang 1 → 1)

## 12. La table ronde agricole se tend  — _campaign/campaign_
...
## 14. Reconquête propose un pacte de non-agression  — _campaign/party_
...
> **Choix retenu :** Refuser le pacte et adresser directement une lettre aux électeurs de Reconquête [OFFENSIF]

**Le RN contourne l’appareil concurrent** — La lettre expose les différences de stratégie et attire une partie des sympathisants. Reconquête reprend ses attaques et mobilise ses cadres pour empêcher tout vote utile.

Sondage : 15.3 → 15.4 (rang 1 → 1)

## 15. Une proposition de pacte de non-agression  — _campaign/campaign_
...
## 16. La porte-parole annonce trop tôt  — _official_campaign/internal_
...
> **Choix retenu :** Adopter immédiatement la baisse annoncée et demander à léquipe budgétaire de la financer [OPPORTUNISTE]

**L’erreur devient une mesure officielle** — La proposition suscite un accueil favorable chez les salariés concernés et évite un démenti humiliant. Le financement improvisé affaiblit votre discipline budgétaire et donne aux porte-parole un précédent dangereux.

Sondage : 15.3 → 15.7 (rang 1 → 1)
...
> **Choix retenu :** L’inviter publiquement à rejoindre votre équipe de campagne [OFFENSIF]
...
## 19. La Garonne sort de son lit  — _official_campaign/world_
...
Sondage : 15.5 → 14.8 (rang 1 → 1)

## 21. Louis Ferran refuse la modération _(CHAÎNE)_ — _official_campaign/party_
...
> **Choix retenu :** Retirer Louis Ferran de la campagne nationale et nommer un coordinateur économique [PRÉSIDENTIEL]
...
## 23. La règle européenne à changer  — _official_campaign/program_
...
Sondage : 15.9 → 14.8 (rang 1 → 1)

## 24. Le courant Ferran teste la discipline _(CHAÎNE)_ — _between_rounds/party_
...
> **Choix retenu :** Exiger une signature individuelle de la ligne présidentielle et exclure les refus de la campagne [OFFENSIF]
...
## 28. Le RN doit élargir sans démobiliser  — _between_rounds/party_
...
> **Choix retenu :** Refuser les accords d’élus et appeler les abstentionnistes à renverser le système des partis [OFFENSIF]
...
Sondage : 14.7 → 13.9 (rang 1 → 1)

## 29. Deux points davance à cinq jours  — _government_epilogue/between_rounds_
...
> **Choix retenu :** Diffuser un dossier comparatif offensif sur les contradictions du finaliste [RISQUÉ]
...
> **Choix retenu :** Écarter les deux candidatures et nommer une économiste fictive indépendante [OFFENSIF]
