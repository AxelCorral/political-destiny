# renaissance — roleplayer — graine 18
...
Sondage : 12.2 → 12 (rang 2 → 2)

## 3. La caméra derrière la porte _(CHAÎNE)_ — _pre_campaign/media_
...
Sondage : 14.6 → 13.2 (rang 1 → 1)

## 10. Le contrôle interne signale trois factures _(CHAÎNE)_ — _campaign/internal_
