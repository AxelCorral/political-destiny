# lfi — neutral_baseline — graine 2

Catégorie de sélection : **top10_fun**

Score final : 77/100 · 1er tour : 16.5 · 2nd tour : 53.4 · qualifié : true · vainqueur : true · signaux mémorables : 6
...
> **Choix retenu :** Élargir l’interdiction des signes religieux ostensibles aux universités [CLIVANT]
...
> **Choix retenu :** Choisir le slogan de rupture et l’accompagner de trois engagements précis [CLIVANT]
...
Sondage : 11 → 12.8 (rang 6 → 2)

## 10. L’imprimeur a doublé une ligne  — _campaign/scandal_
...
## 11. La fronde sociale exige un vote _(CHAÎNE)_ — _campaign/party_
...
> **Choix retenu :** Renoncer aux affiches et financer une campagne numérique dans les six villes [OPPORTUNISTE]
...
Sondage : 13.1 → 9.8 (rang 2 → 8)

## 13. Douze députés offrent leur expérience  — _campaign/alliance_
...
> **Choix retenu :** Annoncer que le programme national sappliquera immédiatement, avec négociation européenne ensuite [CLIVANT]
...
Sondage : 10.9 → 12.2 (rang 6 → 3)

## 18. La Sixième République doit prendre forme  — _official_campaign/party_
...
> **Choix retenu :** Commencer par la proportionnelle et le référendum partagé avant de convoquer une constituante [PRUDENT]

**La nouvelle République devient un chemin en trois étapes** — La trajectoire paraît plus réalisable et élargit les alliances parlementaires possibles. Les militants les plus attachés à la rupture craignent que la constituante soit repoussée indéfiniment.
...
## 20. Le mix électrique de 2040  — _official_campaign/program_
...
> **Choix retenu :** Renoncer aux nouveaux réacteurs et concentrer les crédits sur sobriété, stockage et renouvelables [CLIVANT]

**La sortie du nouveau nucléaire vous définit** — Les électeurs écologistes retrouvent une ligne nette et les acteurs du nucléaire annoncent une mobilisation contraire. Les questions de stockage et de stabilité du réseau deviennent désormais incontournables.

Sondage : 12.8 → 9.6 (rang 2 → 8)

## 21. La collecte se bloque  — _official_campaign/campaign_
...
> **Choix retenu :** Créer un service territorial de soins primaires avec équipes salariées dans les zones sous-dotées [INSTITUTIONNEL]
...
**Dix mesures forment une majorité de gauche** — La coalition obtient un programme positif et déploie tous ses réseaux. Plusieurs engagements LFI sont reportés, ce qui fragilise la cohésion tout en améliorant fortement les reports. La première échéance de l’avance bancaire réduit les moyens disponibles pour la dernière semaine.
...
> **Choix retenu :** Nommer la responsable fictive du programme et lui confier la négociation de la majorité [LOYAL]
