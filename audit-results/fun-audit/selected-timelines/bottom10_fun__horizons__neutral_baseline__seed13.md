# horizons — neutral_baseline — graine 13

Catégorie de sélection : **bottom10_fun**

Score final : 89/100 · 1er tour : 15.1 · 2nd tour : 57.3 · qualifié : true · vainqueur : true · signaux mémorables : 0
...
> **Choix retenu :** Confier la régulation à une autorité indépendante dotée de pouvoirs de sanction [INSTITUTIONNEL]
...
Sondage : 11.9 → 12.3 (rang 3 → 2)

## 2. Un donateur demande un rendez-vous  — _pre_campaign/internal_
...
## 3. Les Républicains proposent un pacte local  — _pre_campaign/party_
...
> **Choix retenu :** Conditionner toute coopération locale à un soutien public avant la campagne officielle [RISQUÉ]

**Le pacte dépend désormais du choix présidentiel** — La demande transforme un accord technique en épreuve de force et donne un enjeu national aux discussions. Plusieurs présidents de département suspendent immédiatement leur participation.

Sondage : 12.3 → 12.2 (rang 2 → 2)

## 4. Douze députés offrent leur expérience  — _pre_campaign/alliance_
...
Sondage : 12.2 → 13.5 (rang 2 → 1)

## 5. Les maires offrent une semaine de terrain  — _pre_campaign/party_
...
> **Choix retenu :** Regrouper les vingt maires lors d’un meeting national consacré aux réussites locales [OFFENSIF]

**Les maires donnent une image de force** — La scène démontre l’implantation du parti et fournit des exemples faciles à raconter. Plusieurs territoires se sentent utilisés comme preuve sans avoir influencé les décisions nationales.

Sondage : 13.5 → 12.5 (rang 1 → 2)
...
## 7. Le direct des questions citoyennes  — _pre_campaign/media_
...
> **Choix retenu :** Répondre à trois questions hospitalières puis conclure avec le calendrier de votre réforme [PRUDENT]
...
## 9. Qui financera les priorités  — _campaign/program_
...
> **Choix retenu :** Supprimer dix niches fiscales identifiées et publier le rendement attendu de chacune [TECHNIQUE]

**Dix avantages ont désormais dix défenseurs** — La liste crédibilise le financement et permet une vérification précise. Chaque secteur concerné organise cependant sa riposte, transformant un arbitrage technique en dix conflits concrets.

Sondage : 13.1 → 13.5 (rang 1 → 1)
...
> **Choix retenu :** Proposer un contrat d’installation aux internes financé pendant cinq ans [POPULAIRE]

**Le contrat attire et interroge** — Les maires soutiennent l’incitation et les étudiants demandent des garanties de logement. Le dispositif paraît durable, avec un coût supérieur à l’équipe mobile.

Sondage : 13.5 → 13.8 (rang 1 → 1)

## 11. Horizons doit sortir de l’attente  — _campaign/party_
...
> **Choix retenu :** Réserver les services publics aux élus et l’économie à une convention nationale [RASSEMBLEUR]

**Deux fabriques produisent le projet** — La répartition valorise le terrain et conserve une ambition économique cohérente. Les propositions de décentralisation devront encore arbitrer entre les deux équipes.

Sondage : 13.8 → 14.2 (rang 1 → 1)

## 12. Une nuit avec les urgences  — _campaign/campaign_
...
> **Choix retenu :** Renoncer à une annonce immédiate et publier un rapport après trois visites [PRUDENT]

**Le silence crée une obligation de résultat** — Les soignants acceptent la méthode parce que vous fixez une date. La presse souligne l’absence d’annonce et attend désormais un document beaucoup plus solide.
...
Sondage : 13.8 → 14.4 (rang 1 → 1)

## 14. La règle de dépense rencontre les communes  — _campaign/party_
...
> **Choix retenu :** Maintenir le plafond et proposer aux communes de fusionner leurs services pour le respecter [CLIVANT]

**La discipline budgétaire s’applique aussi localement** — La règle reste simple et satisfait les électeurs attentifs à la dette. Des maires dénoncent une décentralisation sans autonomie financière et suspendent leur soutien actif.

Sondage : 14.4 → 14.4 (rang 1 → 1)

## 15. Le prochain budget de la santé  — _campaign/program_
...
## 16. L’adversaire refuse de vous laisser répondre  — _official_campaign/debate_
...
Sondage : 14.5 → 13.5 (rang 1 → 1)

## 17. La question de la fin de vie  — _official_campaign/program_
...
> **Choix retenu :** Soumettre la question à référendum après un an de débat parlementaire [INSTITUTIONNEL]

**La décision revient aux citoyens** — La méthode évite de trancher seul un sujet de conscience et paraît difficile à attaquer sur le fond. Les deux camps du débat reprochent au calendrier de retarder une décision qu’ils jugent urgente.

Sondage : 13.5 → 14.9 (rang 1 → 1)
...
> **Choix retenu :** Accepter quatre-vingt-dix minutes en excluant les conflits internes de la discussion [PRUDENT]

**Un entretien solide aux limites apparentes** — Votre propos programmatique est précis, mais l’animateur annonce clairement les thèmes refusés. Le contrôle évite l’accident tout en rappelant au public que la campagne choisit son terrain.

Sondage : 18.7 → 15.3 (rang 1 → 1)
...
> **Choix retenu :** Augmenter le salaire minimum de huit pour cent et compenser temporairement les petites entreprises [POPULAIRE]
...
## 23. Le sketch du « comité Excel »  — _official_campaign/party_
...
> **Choix retenu :** Prononcer un discours personnel et sans notes sur les raisons profondes de sa candidature [RISQUÉ]

**La candidate sort du registre gestionnaire** — Le moment marque, y compris chez des électeurs jusque-là indifférents, et casse un temps l’image de comité d’experts. Certains commentateurs jugent l’exercice trop tardif pour effacer des mois de communication technicienne.
...
Sondage : 16.5 → 17.1 (rang 1 → 1)

## 28. Le centre droit négocie son élargissement  — _between_rounds/party_
...
> **Choix retenu :** Publier seule un contrat de gouvernement puis demander des soutiens sans négocier les postes [PRÉSIDENTIEL]
...
> **Choix retenu :** Limiter le gouvernement à douze membres et fusionner les portefeuilles les plus proches [OFFENSIF]
