# lfi — narrative — graine 7

Catégorie de sélection : **riche_evenements_rares**

Score final : 74/100 · 1er tour : 15.9 · 2nd tour : 49.5 · qualifié : true · vainqueur : false · signaux mémorables : 6
...
Sondage : 9.7 → 12.6 (rang 8 → 2)

## 6. Les abstentionnistes demandent une preuve  — _pre_campaign/party_
...
> **Choix retenu :** Financer des permanences associatives sur les droits sociaux sans condition dadhésion [POPULAIRE]

**La campagne rend un service avant le vote** — Les permanences aident des habitants sur des démarches concrètes et établissent une confiance qui ne dépend pas dun meeting. Le parti doit séparer strictement laide associative de la collecte de données électorales.

Sondage : 12.6 → 12.8 (rang 2 → 1)

## 7. Cent quartiers en porte-à-porte  — _pre_campaign/campaign_
...
> **Choix retenu :** Défendre la mesure phare à chaque porte et recueillir les objections précises [OFFENSIF]

**La mesure résiste aux objections** — Les militants reviennent avec trois critiques récurrentes et des réponses améliorées. Le socle se mobilise, même si certains habitants ont refusé une discussion trop cadrée.
...
> **Choix retenu :** Maintenir un meeting intérieur consacré au climat avec jauge réduite et soignants invités [RISQUÉ]

**Le meeting devient audition sur la canicule** — La jauge réduite et le contenu médical évitent la fête déplacée tout en conservant une parole de campagne. Le rassemblement mobilise malgré tout des services de sécurité pendant l’épisode.

Sondage : 12.9 → 14.1 (rang 1 → 1)
...
## 12. L’immigration de travail, un choix économique assumé ou non  — _campaign/program_
...
Sondage : 13.6 → 17.6 (rang 1 → 1)

## 13. La directrice a recruté son frère  — _campaign/scandal_
...
Sondage : 17.6 → 14 (rang 1 → 1)

## 14. Le double numérique refuse de démarrer _(RARE)_ — _campaign/rare_
...
> **Choix retenu :** Suspendre le meeting jusqu’à réparation et reprendre le discours complet une heure plus tard [RISQUÉ]

**La projection revient devant une salle réduite** — Le système finit par fonctionner et offre les images annoncées. Une partie du public est déjà partie et les commentaires sur l’attente dominent davantage que le contenu.

Sondage : 14 → 14 (rang 1 → 1)

## 15. Le salaire net au centre  — _campaign/program_
...
## 16. Le déplacement en Guadeloupe engage  — _official_campaign/campaign_
...
> **Choix retenu :** Renforcer l’observatoire des prix et publier les marges par filière [TRANSPARENT]
...
Sondage : 15.3 → 14.9 (rang 1 → 1)

## 21. La croissance simulée se retourne  — _official_campaign/world_
...
Sondage : 14.9 → 15.5 (rang 1 → 1)

## 22. Vingt-quatre heures sans caméra  — _official_campaign/media_
...
## 24. Le dernier grand meeting  — _between_rounds/campaign_
