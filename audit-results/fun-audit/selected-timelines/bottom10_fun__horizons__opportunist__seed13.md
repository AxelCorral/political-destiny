# horizons — opportunist — graine 13

Catégorie de sélection : **bottom10_fun**

Score final : 92/100 · 1er tour : 15.7 · 2nd tour : 58.7 · qualifié : true · vainqueur : true · signaux mémorables : 1
...
> **Choix retenu :** Signer une charte de soutien libre avec réunion hebdomadaire et désaccords publiables [INSTITUTIONNEL]
...
Sondage : 14.2 → 15.7 (rang 1 → 1)

## 18. La Garonne sort de son lit — _official_campaign/world_
...
> **Choix retenu :** Suspendre la responsable fictive de la note et commander une revue de tous les documents publiés [OFFENSIF]
...
Sondage : 15.8 → 19.3 (rang 1 → 1)

## 21. Le micro resté ouvert — _official_campaign/media_
...
Sondage : 19.3 → 15.9 (rang 1 → 1)

## 22. La France à cinquante degrés — _official_campaign/program_
...
> **Choix retenu :** Créer un conseil de coalition public avec un représentant de chaque soutien [RASSEMBLEUR]

**La coalition expose ses règles** — Les partenaires expliquent leur contribution et mobilisent leurs réseaux sans prétendre avoir fusionné. Le conseil produit plusieurs messages concurrents pendant une semaine déjà très courte.

Sondage : 17.3 → 14 (rang 1 → 1)
