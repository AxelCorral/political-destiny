# lfi — beginner — graine 5

Catégorie de sélection : **tres_serree**

Score final : 86/100 · 1er tour : 19.7 · 2nd tour : 52.9 · qualifié : true · vainqueur : true · signaux mémorables : 6

## 1. Les jeunes veulent leur propre campagne — _pre_campaign/internal_
...
## 2. Le slogan divise le siège — _pre_campaign/campaign_
...
> **Choix retenu :** Déménager à Saint-Denis et affecter léconomie réalisée aux déplacements régionaux [POPULAIRE]
...
## 4. Cent quartiers en porte-à-porte — _pre_campaign/campaign_
...
> **Choix retenu :** Confier aux équipes un carnet d’écoute et publier la synthèse nationale [RASSEMBLEUR]

**Les préoccupations dessinent une carte** — Les carnets font apparaître des écarts nets entre transports, sécurité et santé. La campagne adapte ses déplacements sans prétendre que l’échantillon vaut sondage.

Sondage : 12.1 → 12.9 (rang 2 → 2)

## 5. Les sections refusent le kit national — _pre_campaign/internal_
...
Sondage : 12.9 → 12.3 (rang 2 → 2)

## 6. Les règles de la liste commune — _pre_campaign/internal_
...
> **Choix retenu :** Nommer vous-même six responsables sur leurs compétences et publier leurs missions précises [PRÉSIDENTIEL]

**Une équipe courte prend les commandes** — Les fonctions sont claires et le travail commence immédiatement. Deux courants sous-représentés dénoncent une présidentialisation du parti et conditionnent leur mobilisation à de futurs arbitrages.

Sondage : 12.3 → 12.4 (rang 2 → 2)

## 7. L’atelier industriel de Saint-Nazaire — _pre_campaign/campaign_
...
> **Choix retenu :** Renoncer au discours préparé et tenir une réunion avec l’équipe de nuit [POPULAIRE]
...
## 8. Des notes de frais se mélangent — _campaign/scandal_
...
Sondage : 12.5 → 14.8 (rang 2 → 1)

## 9. Le car tombe en panne — _campaign/campaign_
...
> **Choix retenu :** Prendre le train avec la presse et maintenir le rendez-vous en retard [POPULAIRE]

**Le retard devient un récit de campagne** — Le trajet ordinaire produit des échanges spontanés et des images sobres. Le rendez-vous commence tard, mais les participants apprécient que vous ne l’ayez pas annulé.

Sondage : 14.8 → 12.8 (rang 1 → 2)

## 10. Une minute sur les loyers — _campaign/media_
...
> **Choix retenu :** Annoncer la garantie publique des loyers étudiants et renvoyer le financement au programme [POPULAIRE]
...
Sondage : 12.8 → 13 (rang 2 → 2)

## 11. Le prochain budget de la santé — _campaign/program_
...
## 12. La désobéissance européenne doit être définie — _campaign/party_
...
> **Choix retenu :** Publier une liste limitée de règles, les mesures françaises concernées et le calendrier de négociation [TRANSPARENT]

**La désobéissance reçoit des objets précis** — La liste rassure sur létendue du conflit et rend vos priorités négociables avec des partenaires. Elle expose chaque mesure à un débat juridique et déçoit ceux qui imaginaient une rupture plus générale.

Sondage : 13.3 → 16 (rang 1 → 1)

## 13. Le siège déborde de bénévoles — _campaign/campaign_
...
Sondage : 16 → 13.8 (rang 1 → 1)

## 14. Nassim Courbet réclame une ligne plus sociale _(CHAÎNE)_ — _campaign/party_
...
> **Choix retenu :** Publier avec Nassim Courbet un texte reliant salaires, partage du pouvoir et services publics [RASSEMBLEUR]

**Le conflit produit une articulation politique** — Le texte évite de choisir entre social et institutions et donne aux militants des arguments concrets. Nassim Courbet reconnaît larbitrage tout en conservant son réseau et sa capacité de critique.

Sondage : 13.8 → 14.2 (rang 1 → 1)

## 15. Provoquer le favori en duel — _campaign/debate_
...
## 16. Contrôles aux frontières : quels moyens — _official_campaign/program_
...
Sondage : 14.4 → 18.1 (rang 1 → 1)

## 17. Vingt-quatre heures sans caméra — _official_campaign/media_
...
Sondage : 18.1 → 14.9 (rang 1 → 1)

## 18. L’immigration de travail, un choix économique assumé ou non — _official_campaign/program_
...
> **Choix retenu :** Confier aux branches professionnelles la négociation annuelle des quotas par métier [RASSEMBLEUR]
...
> **Choix retenu :** Résumer trois engagements, leur financement et la première décision des cent jours [PRÉSIDENTIEL]
...
Sondage : 15.3 → 15.6 (rang 1 → 1)

## 20. La fronde sociale exige un vote _(CHAÎNE)_ — _official_campaign/party_
...
> **Choix retenu :** Organiser le vote en séparant la priorité programmatique du rôle personnel de Nassim Courbet [TRANSPARENT]

**Deux questions empêchent un plébiscite personnel** — Les adhérents renforcent la priorité sociale et refusent de créer une codirection. Nassim Courbet accepte le résultat, retrouve un rôle thématique et cesse de menacer la campagne.

Sondage : 15.6 → 19.5 (rang 1 → 1)

## 21. Les tentes encerclent la préfecture — _official_campaign/world_
...
## 23. Le fauteuil libéré au vingt heures — _official_campaign/media_
...
> **Choix retenu :** Proposer qu’un allié présente votre programme pendant que vous préparez le débat [RASSEMBLEUR]
...
Sondage : 16.2 → 16.3 (rang 1 → 1)

## 24. Le meeting quitte la capitale — _between_rounds/campaign_
...
> **Choix retenu :** Tenir le meeting à Lille et détailler le plan de réindustrialisation [POPULAIRE]

**Lille replace l’industrie au centre** — Les images d’anciens sites industriels donnent une matière concrète au discours. Le message progresse chez les salariés, moins auprès des électeurs centrés sur les services.

Sondage : 16.3 → 16.5 (rang 1 → 1)
...
> **Choix retenu :** Prononcer une adresse de rassemblement sans nouvelle mesure ni attaque personnelle [PRÉSIDENTIEL]
...
> **Choix retenu :** Garantir un vote parlementaire avant toute désobéissance européenne et maintenir le reste du programme [RASSEMBLEUR]

**Le Parlement devient le garde-fou de la rupture** — Les soutiens de gauche obtiennent une garantie institutionnelle sans réécrire vos mesures sociales. Les reports progressent et le socle accepte mieux une concession portant sur la méthode.

Sondage : 16.9 → 14.1 (rang 1 → 1)
...
> **Choix retenu :** Signer les huit mesures compatibles et publier pourquoi les quatre autres sont écartées [TRANSPARENT]
...
> **Choix retenu :** Choisir le responsable le plus compétent et offrir à lautre la présidence dun comité parlementaire [INSTITUTIONNEL]
